...
/**
 * @func spinner
 * @desc Builds string for event emitter err.
 * @param {string} spinner - spinner in error
 * @returns {string} String for emit.('err')
 */
function completed(spinner) {
  return `${name}: ${spinner} spinner was completed by an error`
}
